...
export class Erc20Contract extends EthereumContract {
    ...
    // call
    async approve(address: string, amount: BigNumber, gas: GasPrice): Promise<TransactionResponse> {
        return this.call(
            'approve',
            [address, amount],
            gas,
...
export class LpSub2SubBridgeContract extends EthereumContract {
    ...
    async tryRelay(args: RelayArgs, gasLimit: BigNumber | null = null): Promise<string> | null {
        var value = null;
